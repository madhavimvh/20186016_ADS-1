...
public final class Solution {
	public static void main(String[] args) {
		...
		BinarySearchST<String, Integer> bstmin = new BinarySearchST<String, Integer>();
		BinarySearchST<String, Integer> bstmax = new BinarySearchST<String, Integer>();
		...
		while (N > 0) {
			...
			for (int i = 0; i < 5; i++) {
				...
				if (bstmax.contains(temp.getName())) {
					bstmax.put(temp.getName(), bstmax.get(temp.getName()) + 1);
				} else {
					bstmax.put(temp.getName(), 1);
				}
				System.out.println(temp.getName() + " " + temp.getPerchange());
			}
			System.out.println();
			for (int i = 0; i < 5; i++) {
				Stock inp1 = min.delMin();
				if (bstmin.contains(inp1.getName())) {
					bstmin.put(inp1.getName(), bstmin.get(inp1.getName()) + 1);
				} else {
					bstmin.put(inp1.getName(), bstmin.get(inp1.getName()));
				}
